  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        setError(
          err instanceof ApiError ? err.detail : "Не удалось создать организацию.",
        );
      } finally {
        setPending(false);
      }
    },
    [legalName, shortName, orgType, legalAddress, actualAddress, directorName, phone, email, comment, identifiers, router],
  );
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              ...
              <Button type="button" variant="outline" asChild>
                <Link href="/organizations">Отмена</Link>
              </Button>
            </div>
          </CardContent>
        </Card>
