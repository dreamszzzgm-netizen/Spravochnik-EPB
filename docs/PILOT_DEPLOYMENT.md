...
- часть Next.js экранов всё ещё использует mock-data и ещё не является полноценным интерфейсом ко всем backend-модулям;
...
- раннего UX/эксплуатационного тестирования.
